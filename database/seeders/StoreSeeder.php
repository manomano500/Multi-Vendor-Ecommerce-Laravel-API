...
class StoreSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Create stores
        $stores = Store::factory()->count(60)->create()->each(function ($store) use (&$storeCount) {
            ...
            Product::factory()->count(40)->create()->each(function ($product) use ($store, &$productCount, $storeCount) {
